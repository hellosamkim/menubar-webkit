...
**Quark Shell** helps you create cross-platform (currently Mac and Windows) menubar/tray app using HTML and JavaScript without writing any native code. Quark Shell exposes an JavaScript object called ``mw`` to provide system functions. **Quark Shell for Mac** is based on WebKit.
